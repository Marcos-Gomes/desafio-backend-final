...
const validarInsercaoPedido = require("./intermediarios/validarInsercaoPedido");
const validarPedidoExiste = require("./intermediarios/validarPedidoExiste");
...
rotas.post("/pedido", validarInsercaoPedido, validarCorpoPedido, cadastrarPedido);
rotas.get("/pedido", validarPedidoExiste, listarPedidos);
